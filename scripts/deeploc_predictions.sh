...
deeploc2 -f results_reduced/protein_sequence_dataset_pairs.fasta -m Fast -o results_reduced/ -d cuda

echo "Starting DeepLoc predictions for results_reduced at $(date)"
deeploc2 -f results_reduced/protein_sequence_dataset_pairs.fasta -m Accurate -o results_reduced/ -d cuda
